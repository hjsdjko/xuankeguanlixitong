    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(xueshengchengji !=null){
            ...
            BeanUtils.copyProperties( xueshengchengji , view );//把实体数据重构到view中
                ...
                //级联表
                KechengziyuanEntity kechengziyuan = kechengziyuanService.selectById(xueshengchengji.getKechengziyuanId());
                if(kechengziyuan != null){
                    BeanUtils.copyProperties( kechengziyuan , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setKechengziyuanId(kechengziyuan.getId());
                }
                //级联表
    ...
    */
    ...
    public R save(@RequestBody XueshengchengjiEntity xueshengchengji, HttpServletRequest request){
        ...
        Wrapper<XueshengchengjiEntity> queryWrapper = new EntityWrapper<XueshengchengjiEntity>()
            ...
            .eq("kechengziyuan_id", xueshengchengji.getKechengziyuanId())
            .eq("chengji", xueshengchengji.getChengji())
            .eq("xuefen", xueshengchengji.getXuefen())
...
//                            xueshengchengjiEntity.setKechengziyuanId(Integer.valueOf(data.get(0)));   //教师 要改的
//                            xueshengchengjiEntity.setChengji(Integer.valueOf(data.get(0)));   //成绩 要改的
//                            xueshengchengjiEntity.setXuefen(Integer.valueOf(data.get(0)));   //学分 要改的
